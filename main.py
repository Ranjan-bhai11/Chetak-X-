...
# 🚀 ULTRA-PREMIUM CYBER DIGITAL LOADING CONSOLE - 100% GLITCH FREE
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        /* 🚨 NEW FUTURISTIC CYBER SPLASH OVERLAY */
        #splash-screen { 
            position: fixed; 
            inset: 0; 
            background: #000000; 
        ...
        .splash-main-logo { font-size: 38px; font-weight: 700; color: #FFFFFF; letter-spacing: 6px; margin-bottom: 5px; text-align: center; }
        .splash-main-logo span { color: #FF1E1E; }
        .splash-sub { font-size: 10px; color: #444; letter-spacing: 4px; text-transform: uppercase; margin-bottom: 50px; }
        ...
        .inner-core {
            width: 120px;
            height: 120px;
            background: radial-gradient(circle, #09090b 0%, #020202 100%);
        ...
        .core-counter span { color: #FF1E1E; font-size: 12px; margin-left: 2px; }
        ...
        .init-text { font-size: 11px; color: #FF1E1E; letter-spacing: 4px; font-weight: 600; margin-top: 50px; text-transform: uppercase; text-align: center; min-height: 20px; }
...
<body>
    ...
    <!-- 🚨 NEW CYBER DIGITAL CORE OVERLAY SPLASH -->
    <div id="splash-screen">
        ...
        <div class="core-container">
            ...
            <div class="inner-core">
                <div class="core-counter" id="percentage-node">0<span>%</span></div>
            </div>
        </div>
        
        <div class="init-text" id="status-label">INITIALIZING SYSTEM CORE...</div>
    </div>
    ...
    <script>
        // 🛠️ DYNAMIC AUTOMATIC 15-SECOND LOADING MATRIX LOGIC
        window.addEventListener('DOMContentLoaded', () => {
            ...
            let currentPct = 0;
            const targetTime = 15000; // 15 Seconds Exact
            const intervalTime = targetTime / 100;

            const loaderInterval = setInterval(() => {
                currentPct++;
                pctNode.innerHTML = `${currentPct}<span>%</span>`;
                
                // Status notifications at intervals
                if (currentPct === 25) statusLabel.innerText = "LOADING SECURE ENGINES...";
        ...
        async function sendMessage() {
            ...
            try {
                ...
                errWrap.innerHTML = `<div class="message ai-message">⚠️ System glitch! Dubara try karo bhai.</div><span class="msg-time">${timeStr}</span>`;

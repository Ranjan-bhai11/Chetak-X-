...
# 🕉️ Front-end Greeting Har Har Mahadev Set Hai
...
# Chote aur limited static responses taaki AI par zyada asar na pade
LOCAL_RESPONSES = {
...
# 🛠️ SOLID ATTITUDE SYSTEM INSTRUCTIONS (Haryanvi/Desi Style Friendly Mix)
SYSTEM_INSTRUCTION = """
...
def ask():
    ...
    # Static checking sirf tabhi chalegi jab text poora exact match ho
    ...
    try:
        ...
        # Har baar AI ko context aur instructions bilkul sahi se yaad dilane ke liye

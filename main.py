...
# 🕉️ Har Har Mahadev Greeting Set Hai
...
# Exact matching ke liye local clean responses
LOCAL_RESPONSES = {
...
def ask():
    ...
    # 🛠️ FIXED: Pure text ko lower karke clean list banayi hai
    clean_input = user_input.lower().strip()
    
    # Exact full match check karega taaki hindi ka 'hi' problem na kare
